namespace :branding do
  ...
  task generate_app_icons: :environment do
    favicon_source  = Rails.root.join('app', 'javascript', 'images', 'awesome-garden-icon.svg')
    app_icon_source = Rails.root.join('app', 'javascript', 'images', 'awesome-garden-icon.svg')
